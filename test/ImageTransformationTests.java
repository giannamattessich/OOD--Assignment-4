...
public class ImageTransformationTests {
  Pixel[][] pixels = {{new Pixel(181, 39, 34),
          new Pixel(181, 88, 34), new Pixel(204, 167, 20)},
          {new Pixel(24, 201, 39), new Pixel(22, 148, 201),
                  new Pixel(79, 24, 199)}};

  @Test
  public void testRedTransform() {
    Pixel[][] redPixels = {{new Pixel(181, 181, 181),
            new Pixel(181, 181, 181), new Pixel(204, 204, 204)},
            {new Pixel(24, 24, 24), new Pixel(22, 22, 22),
                    new Pixel(79, 79, 79)}};
  ...
  public void testGreenTransform() {
    Pixel[][] greenPixels = {{new Pixel(39, 39, 39),
            new Pixel(88, 88, 88), new Pixel(167, 167, 167)},
            {new Pixel(201, 201, 201), new Pixel(148, 148, 148),
                    new Pixel(24, 24, 24)}};
  ...
  public void testBlueTransform() {
    Pixel[][] bluePixels = {{new Pixel(34, 34, 34),
            new Pixel(34, 34, 34), new Pixel(20, 20, 20)},
            {new Pixel(39, 39, 39), new Pixel(201, 201, 201),
  ...
  public void testValueTransform() {
    Pixel[][] valuePixels = {{new Pixel(181, 181, 181),
            new Pixel(181, 181, 181), new Pixel(204, 204, 204)},
            {new Pixel(201, 201, 201), new Pixel(201, 201, 201),
                    new Pixel(199, 199, 199)}};
  ...
  public void testIntensityTransform() {
    Pixel[][] intensityPixels = {{new Pixel(84, 84, 84),
            new Pixel(101, 101, 101), new Pixel(130, 130, 130)},
            {new Pixel(88, 88, 88), new Pixel(123, 123, 123),
  ...
  public void testLumaTransform() {
    Pixel[][] lumaPixels = {{new Pixel(68, 68, 68),
            new Pixel(103, 103, 103), new Pixel(164, 164, 164)},
            {new Pixel(151, 151, 151), new Pixel(125, 125, 125),
                    new Pixel(48, 48, 48)}};
  ...
  public void testBrightenTransform() {
    Pixel[][] brightPixels = {{new Pixel(241, 99, 94),
            new Pixel(241, 148, 94), new Pixel(255, 227, 80)},
            {new Pixel(84, 255, 99), new Pixel(82, 208, 255),
  ...
  public void testDarkenTransform() {
    Pixel[][] darkPixels = {{new Pixel(121, 0, 0),
            new Pixel(121, 28, 0), new Pixel(144, 107, 0)},
            {new Pixel(0, 141, 0), new Pixel(0, 88, 141),
                    new Pixel(19, 0, 139)}};
  ...
  public void testVertFlip() {
    Pixel[][] vertPixels = {{new Pixel(24, 201, 39),
            new Pixel(22, 148, 201), new Pixel(79, 24, 199)},
            {new Pixel(181, 39, 34), new Pixel(181, 88, 34),
  ...
  public void testHorFlip() {
    Pixel[][] horPixels = {{new Pixel(204, 167, 20),
            new Pixel(181, 88, 34), new Pixel(181, 39, 34)},
            {new Pixel(79, 24, 199), new Pixel(22, 148, 201),
                    new Pixel(24, 201, 39)}};
  ...
  public void testPixels() {
    ...
    for (int i = 0; i < pixels.length; i++) {
      for (int j = 0; j < pixels[0].length; j++) {
        System.out.print("Pixel at "+ i +", "+ j + ": " + "Pixel(" +
                redImg.getPixelAt(i, j).getRed() + ", " + redImg.getPixelAt(i, j).getGreen() + ", " +
                redImg.getPixelAt(i, j).getBlue() + ")" + System.lineSeparator());
      }
    }
  }
  ...
  public void testSharpen() {
    Pixel[][] sharpPixel = {{new Pixel(117, 40, 28),
            new Pixel(117, 88, 28), new Pixel(99, 129, 19)},
            {new Pixel(24, 99, 40), new Pixel(23, 141, 99),
                    new Pixel(81, 24, 105)}};
  ...
  public void testBlur() {
    Pixel[][] blurPixel = {{new Pixel(177, 33, 32),
            new Pixel(177, 86, 32), new Pixel(199, 161, 17)},
            {new Pixel(22, 198, 33), new Pixel(17, 145, 198),
                    new Pixel(71, 22, 193)}};
    Image testBTransform = new ImageModel(pixels);
  ...
  public void testGreyscale() {
    Pixel[][] greyScalePixel = {{new Pixel(68, 137, 206),
            new Pixel(103, 207, 255), new Pixel(164, 255, 255)},
            {new Pixel(151, 255, 255), new Pixel(125, 250, 255),
                    new Pixel(48, 96, 144)}};
    Image testGTransform = new ImageModel(pixels);
  ...
  public void testSepia() {
    Pixel[][] sepiaPixel = {{new Pixel(107, 203, 255),
            new Pixel(145, 255, 255), new Pixel(212, 255, 255)},
            {new Pixel(171, 255, 255), new Pixel(160, 255, 255),
